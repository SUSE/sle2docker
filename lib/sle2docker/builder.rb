module Sle2Docker
  # This class takes care of starting the actual kiwi process
  # to build the image.
  class Builder
    ...
    def find_template_file(template_dir)
      ...
      unless File.exist?(template_file)
        fail ConfigNotFoundError,
             "Cannot find config.xml.erb file inside of #{template_dir}"
      end
